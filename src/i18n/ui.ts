...
export const ui = {
  en: {
    ...
    'posts.description': 'Notes and Reflections.',
    'posts.title': 'Posts',
    'postNav.next': 'Next',
    'postNav.navigation': 'Post navigation',
    'postNav.previous': 'Previous',
    'projects.description': 'My internship experience.',
    'projects.title': 'Internship',
  ...
  'zh-cn': {
    ...
    'posts.description': '记录与感想。',
    'posts.title': '文章',
    'postNav.next': '下一篇',
    'postNav.navigation': '文章导航',
    'postNav.previous': '上一篇',
    'projects.description': '我的实习经历。',
    'projects.title': '实习',
    'related.title': '相关文章',
